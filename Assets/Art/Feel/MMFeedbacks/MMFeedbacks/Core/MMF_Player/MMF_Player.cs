...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_Player : MMFeedbacks
    {
        ...
        public override void PlayFeedbacks(Vector3 position, float feedbacksIntensity = 1.0f,
        ...
        protected override void PreparePlay(Vector3 position, float feedbacksIntensity,
            bool forceChangeDirection = false)
        {
        ...
        protected override void PlayAllFeedbacks(Vector3 position, float feedbacksIntensity,
            bool forceChangeDirection = false)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                if (FeedbacksList[i].Active
                    && ((FeedbacksList[i].IsPlaying
                        ...
                        || (FeedbacksList[i].IsPlaying && (FeedbacksList[i].Timing.NumberOfRepeats > 0) &&
                            (FeedbacksList[i].PlaysLeft > 0))))
                {
                    return true;
                }
            }
