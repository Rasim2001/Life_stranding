...
namespace Infastructure.StaticData.Spider
{
    ...
    public class SpiderStaticData : ScriptableObject
    {
        ...
        // Якорь: паук на земле, осел, разворот не идёт, и его верх отклонён от мировой вертикали
        // не больше этого угла — цель горизонта становится ровно Vector3.up. Константа, а не верх
        // паука: писать верх паука значило бы следить за корпусом на малых углах. Порог отвечает
