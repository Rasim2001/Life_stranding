Shader "GameDevBuddies/CustomTerrainLit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        // This pass is used when drawing depth/normals for terrain icons.
        Pass
        {
            Name "DepthNormals"
            Tags{"LightMode" = "DepthNormalsTerrainIcons"}
            ...
            #include "Packages/com.unity.render-pipelines.universal/Shaders/Terrain/TerrainLitInput.hlsl"
            //#include "Packages/com.unity.render-pipelines.universal/Shaders/Terrain/TerrainLitDepthNormalsPass.hlsl"
            #include "./CustomTerrainLitDepthNormal.hlsl"
            ENDHLSL
        }
