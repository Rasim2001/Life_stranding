...
Shader "SpiderRig/Experiments/ENV_LitTopReliefProof"
{
    Properties
    {
        ...
        // Общего пространства проекции больше нет: у градиента (_GradientSpace) и слоя Top
        // (_OverlaySpace0) свои переключатели, у масок слоёв Blend — _MixPatternProjectionN.
        ...
        // своё свойство слоя, _OverlaySpace0.
