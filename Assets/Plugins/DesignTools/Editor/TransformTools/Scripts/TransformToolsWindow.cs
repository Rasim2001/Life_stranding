...
namespace PluginMaster
{
    public class TransformToolsWindow : BaseToolWindow
    {
        ...
        private static bool _buttonsLoaded = false;
        private void LoadButtons()
        {
            _buttonStyle = skin.GetStyle("ToolButton");
        ...
        private void OnGuiAlignGroup()
        {
            ...
            {
                GUILayout.Label("Relative to:", skin.label, GUILayout.Height(18));
                ...
                if (_relativeTo != TransformTools.RelativeTo.SELECTION && _relativeTo != TransformTools.RelativeTo.CANVAS)
                {
                    ...
                    {
                        GUILayout.Label("Space:", skin.label, GUILayout.Height(18));
                        _space = (Space)UnityEditor.EditorGUILayout.Popup((int)_space, _spaceOptions, GUILayout.Width(85));
                        GUILayout.FlexibleSpace();
                    }
                }
                GUILayout.Label("Align property:", skin.label, GUILayout.Width(88), GUILayout.Height(18));
                ...
                using (new GUILayout.HorizontalScope())
                {
                    ...
                    GUILayout.Label("Topmost filter", skin.label, GUILayout.Height(18));
                    GUILayout.FlexibleSpace();
                }
                GUILayout.Space(4);
                ///// X
                ...
                using (new GUILayout.HorizontalScope())
                {
                    ...
                    if (_pivot != null)
                    {
                        if (GUILayout.Button(_applyPivotButton, _buttonStyle))
                        {
                            ...
                            if (meshFilter == null && skinnedRenderer == null) TransformTools.MoveChildren(_pivot.transform);
