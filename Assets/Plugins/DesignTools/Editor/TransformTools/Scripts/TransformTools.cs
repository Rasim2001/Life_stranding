    ...
    public static class TransformTools
    {
            ...
            Transform pivot, System.Collections.Generic.List<Transform> otherObjects)
        {
            ...
            if (!string.IsNullOrEmpty(UnityEditor.AssetDatabase.GetAssetPath(mesh)))
            {
                ...
                var allFilters = UnityEngine.Object.FindObjectsByType<MeshFilter>(FindObjectsSortMode.None);
#else
            ...
            Transform pivot, System.Collections.Generic.List<Transform> otherObjects)
        {
            ...
            if (!string.IsNullOrEmpty(UnityEditor.AssetDatabase.GetAssetPath(mesh)))
            {
                mesh = UnityEngine.Object.Instantiate(mesh);
#if UNITY_2022_2_OR_NEWER
                var allRenderers = UnityEngine.Object.FindObjectsByType<SkinnedMeshRenderer>(FindObjectsSortMode.None);
#else
...
#if UNITY_2022_2_OR_NEWER
            var allRenderers = UnityEngine.Object.FindObjectsByType<SpriteRenderer>(FindObjectsSortMode.None);
#else
