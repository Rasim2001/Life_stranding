...
namespace RealBlend
{
    ...
    // Полное имя типа вместо короткого: в проекте есть глобальный `namespace Editor`
    // (Assets/Editor/**), и внутри `namespace RealBlend` короткое `Editor` разрешается
    // в него, а не в UnityEditor.Editor — CS0118. Правка живёт в купленном ассете
    // и слетит при его обновлении; причина лечится переименованием нашего namespace,
    // см. .scratch/inbox/namespace-editor-collision.md
    public class VertexPaintStorageEditor : UnityEditor.Editor
    {
